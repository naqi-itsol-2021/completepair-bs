export default function privacy() {
  return (
    <body className="privacybackgroudcolor">
      <main className="px-4 overflow-x-hidden bg-grid">
        <div className="py-12 sm:py-16 lg:py-24">
          <div className="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto space-y-2 lg:max-w-none">
              <h2 className="mt-1 mb-8 text-4xl text-gray-900 font-cal sm:text-5xl lg:text-6xl">
                Privacy Policy
              </h2>
            </div>
          </div>
        </div>
        <div className="mx-auto prose max-w-7xl md:px-7">
          <div className="bg-white md:px-8">
            Effective date: 8/30/2022 <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Introduction</h2>
            <br />
            <p>Welcome to completepairbooking.app.</p>
            <p>
              completepairbooking.app (“us”, “we”, or “our”) operates https://completepairbooking.app
              (hereinafter referred to as “Service”).
            </p>
            <p>
              Our Privacy Policy governs your visit to https://completepairbooking.app, and explains how we
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Definitions</h2>
            <br />
            <p>
              SERVICE means the https://completepairbooking.appwebsite operated by completepairbooking.app.
            </p>
            <p>
            ...
            <p>
              DATA SUBJECT is any living individual who is the subject of Personal Data. THE USER is the
              individual using our Service. The User corresponds to the Data Subject, who is the subject of
              Personal Data.
            </p>
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Information Collection and Use</h2>
            <br />
            <p>
            ...
            <p>
              ...
              any, or all, of these communications from us by following the unsubscribe link or by emailing at
              support@completepairbooking.app
            </p>
            <p>
              <br />
              <br />
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Use of Data</h2>
            <br />
            <p>completepairbooking.app uses the collected data for various purposes:</p>
            <ul>
              ...
              <li>
                to provide you with notices about your account and/or subscription, including expiration and
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Retention of Data</h2>
            <br />
            <p>
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Transfer of Data</h2>
            <br />
            <p>
            ...
            <p>
              completepairbooking.app will take all the steps reasonably necessary to ensure that your data is
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Disclosure of Data</h2>
            <br />
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Security of Data</h2>
            <br />
            <p>
            ...
            <p>
              ...
              from our systems, please email us at support@completepairbooking.app.
            </p>
            ...
            <ul>
              ...
              <li>
                A list of categories of personal information that we have sold, along with the category of any
            ...
            <p>
              Please note, you are entitled to ask us to provide you with this information up to two times in
              a rolling twelve-month period. When you make this request, the information provided may be
            ...
            <p>
              ...
              not be able to use certain functions that require your personal information to operate.
            </p>
            <p>
              To stop selling your personal information. We don't sell or rent your personal information to
              any third parties for any purpose. You are the only owner of your Personal Data and can request
            ...
            <p>
              ...
              with us, and you may not be able to participate in certain programs or membership services which
            ...
            <p>By email: support@completepairbooking.app.</p>
            <p>
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Service Providers</h2>
            <br />
            <p>
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Analytics</h2>
            <br />
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">CI/CD tools</h2>
            <br />
            <p>
            ...
            <p>
              For more information on what data GitHub collects for what purpose and how the protection of the
              data is ensured, please visit GitHub Privacy Policy page:
              https://help.github.com/en/articles/github-privacy-statement.
            </p>
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Payments</h2>
            <br />
            <p>
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Links to Other Sites</h2>
            <br />
            <p>
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Children's Privacy</h2>
            <br />
            <p>
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Changes to This Privacy Policy</h2>
            <br />
            <p>
            ...
            <br />
            <br />
            <h2 className="text-3xl text-gray-900 dark:text-white">Contact Us</h2>
            <br />
